...
<body>
    ...
    <script type="text/javascript">
        ...
        const baseUrl = "https://maps.geoapify.com/v1/tile/{{$theme}}/{z}/{x}/{y}.png?apiKey={apiKey}";
        const retinaUrl = "https://maps.geoapify.com/v1/tile/{{$theme}}/{z}/{x}/{y}@2x.png?apiKey={apiKey}";
